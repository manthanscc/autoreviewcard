...
function App() {
  ...
  const faqs = [
    {
      ...
      answer: "Yes, our platform seamlessly integrates with any Google Business Profile. We comply with all Google policies and guidelines to ensure your reviews are legitimate and safe."
    },
    {
      question: "How does the AI write review prompts?",
      answer: "Our AI analyzes your business type, customer interaction, and industry best practices to generate personalized, natural-sounding review requests that feel authentic to your customers."
    },
    {
      question: "Is this compliant with Google's review policies?",
      answer: "Absolutely. We strictly follow Google's review policies. We never incentivize reviews or violate terms of service. Our system simply makes it easier for satisfied customers to leave genuine feedback."
    },
    {
      question: "How quickly can I get started?",
      answer: "Setup takes less than 5 minutes. Once you sign up, you'll get your custom QR code immediately and can start collecting reviews right away."
    },
    {
      question: "What kind of support do you provide?",
      answer: "We offer 24/7 customer support via WhatsApp, email, and live chat. Our team is always ready to help you maximize your review collection success."
    }
  ];

  const industries = [
    { name: "Healthcare", icon: Stethoscope, color: "from-blue-500 to-blue-600", bgColor: "bg-blue-50", textColor: "text-blue-600" },
    { name: "Salons & Spas", icon: Scissors, color: "from-pink-500 to-pink-600", bgColor: "bg-pink-50", textColor: "text-pink-600" },
    { name: "Hotels", icon: Hotel, color: "from-purple-500 to-purple-600", bgColor: "bg-purple-50", textColor: "text-purple-600" },
    { name: "Gyms", icon: Dumbbell, color: "from-green-500 to-green-600", bgColor: "bg-green-50", textColor: "text-green-600" },
    { name: "Restaurants", icon: Utensils, color: "from-orange-500 to-orange-600", bgColor: "bg-orange-50", textColor: "text-orange-600" },
    { name: "Auto Shops", icon: Car, color: "from-red-500 to-red-600", bgColor: "bg-red-50", textColor: "text-red-600" },
    { name: "Offices", icon: Building, color: "from-indigo-500 to-indigo-600", bgColor: "bg-indigo-50", textColor: "text-indigo-600" },
    { name: "Cafes", icon: Coffee, color: "from-amber-500 to-amber-600", bgColor: "bg-amber-50", textColor: "text-amber-600" }
  ];
  ...
  const features = [
    {
      ...
      description: "Smart AI crafts personalized review prompts for each customer interaction",
    ...
    },
    {
      ...
      description: "Optimized for mobile devices where your customers spend most of their time",
    ...
    },
    {
      ...
      description: "Track review requests, response rates, and business growth metrics",
    ...
    },
    {
      icon: Clock,
      title: "24/7 Support",
      description: "Round-the-clock customer support via WhatsApp, email, and live chat",
    ...
    },
    {
      icon: Zap,
      title: "Instant Setup",
      description: "Get your QR code and start collecting reviews in under 5 minutes",
  ...
  const stats = [
    { icon: Star, value: "50,000+", label: "Reviews Generated", color: "text-yellow-500" },
    { icon: Users, value: "2,500+", label: "Active Users", color: "text-blue-500" },
    { icon: Award, value: "4.9", label: "Average Rating", color: "text-green-500" },
  ...
  const caseStudies = [
    {
      industry: "Healthcare",
      rating: 5,
      quote: "ReviewBoost AI transformed our patient feedback process completely. We went from 2-3 reviews per month to 45+ reviews monthly. The AI timing is incredible - it knows exactly when patients are happiest with our service.",
    ...
    },
    {
      industry: "Restaurant",
      rating: 5,
      quote: "We scaled from scattered feedback to a steady stream of glowing reviews. Staff no longer push manually; guests just scan and approve. Our local ranking jumped significantly.",
      author: "Raj Patel",
    ...
    },
    {
      industry: "Fitness",
      rating: 5,
      quote: "Members love the seamless flow. Check-in + session finish triggers perfect timing. We now average 60+ new reviews every month across locations.",
      author: "Ankit Verma",
      title: "Co-Founder",
  ...
  const prevCase = () => setCaseIndex(i => (i - 1 + caseStudies.length) % caseStudies.length);
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 py-20 text-center">
          <div className={`transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
            <div className="inline-flex items-center gap-2 bg-white/10 backdrop-blur-sm border border-white/20 rounded-full px-6 py-2 mb-8 animate-fade-in-up">
              ...
              <span className="text-sm font-medium">Trusted by 2,500+ businesses worldwide</span>
            </div>
            ...
            <p className="text-xl md:text-2xl mb-12 text-slate-300 max-w-4xl mx-auto leading-relaxed animate-fade-in-up animation-delay-400">
              Boost credibility, attract new customers, and grow your business reputation without asking customers manually. Our AI-powered QR codes make it effortless.
            </p>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-20">
            ...
            <h2 className="text-4xl md:text-5xl font-bold text-slate-900 mb-6 animate-fade-in-up animation-delay-200">
              Why Asking for Reviews <span className="text-red-500">Manually Fails</span>
            </h2>
            <p className="text-xl text-slate-600 max-w-3xl mx-auto animate-fade-in-up animation-delay-400">
              Traditional methods create barriers that prevent satisfied customers from sharing their positive experiences.
            </p>
          </div>

          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            {[
              { icon: Heart, title: "Too Awkward", desc: "Asking customers directly feels pushy and uncomfortable", color: "from-red-500 to-pink-500", bg: "bg-red-50" },
              { icon: Clock, title: "Takes Time", desc: "Staff waste time explaining instead of serving customers", color: "from-orange-500 to-yellow-500", bg: "bg-orange-50" },
              { icon: Target, title: "Customers Forget", desc: "Even willing customers forget by the time they get home", color: "from-purple-500 to-indigo-500", bg: "bg-purple-50" },
              { icon: Settings, title: "Complex Process", desc: "Finding and reviewing on Google is more complicated than it should be", color: "from-blue-500 to-cyan-500", bg: "bg-blue-50" }
            ].map((problem, index) => {
              const Icon = problem.icon;
              return (
                <div key={index} className={`group ${problem.bg} rounded-3xl p-8 hover:shadow-2xl transition-all duration-500 hover:scale-105 hover:-translate-y-2 animate-slide-in-up animation-delay-${(index + 1) * 200}`}>
                  <div className={`w-16 h-16 bg-gradient-to-br ${problem.color} rounded-2xl flex items-center justify-center mb-6 group-hover:scale-110 group-hover:rotate-6 transition-all duration-300 shadow-lg`}>
                    <Icon className="w-8 h-8 text-white" />
                  </div>
                  <h3 className="text-xl font-bold text-slate-900 mb-3 group-hover:text-slate-700 transition-colors">{problem.title}</h3>
                  <p className="text-slate-600 group-hover:text-slate-700 transition-colors">{problem.desc}</p>
                </div>
              );
            })}
          </div>
      ...
      <section className="py-24 px-4 bg-gradient-to-br from-white to-slate-50 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto relative">
          <div className="text-center mb-20">
            ...
            <h2 className="text-4xl md:text-5xl font-bold text-slate-900 mb-6 animate-fade-in-up animation-delay-200">
              AI Makes Review Collection <span className="bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent">Effortless</span>
            </h2>
            <p className="text-xl text-slate-600 max-w-3xl mx-auto animate-fade-in-up animation-delay-400">
              Transform the review process into a simple, engaging experience that customers actually enjoy.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-4 gap-8 relative">
            ...
            {[
              { icon: QrCode, title: "Scan QR Code", desc: "Customer scans your custom QR code with their smartphone", color: "from-blue-500 to-blue-600", step: "1" },
              { icon: Sparkles, title: "AI Suggestion", desc: "AI generates a personalized review based on their experience", color: "from-purple-500 to-purple-600", step: "2" },
              { icon: CheckCircle, title: "Customer Approves", desc: "Customer reviews and approves the AI-generated content", color: "from-green-500 to-green-600", step: "3" },
              { icon: Star, title: "Review Posted", desc: "Review is instantly published to your Google Business Profile", color: "from-orange-500 to-red-500", step: "4" }
            ].map((step, index) => {
              const Icon = step.icon;
              return (
                <div key={index} className={`relative z-10 text-center group animate-fade-in-up animation-delay-${(index + 1) * 200}`}>
                  <div className="relative mb-6">
                    <div className={`w-20 h-20 bg-gradient-to-br ${step.color} rounded-3xl flex items-center justify-center mx-auto shadow-2xl group-hover:scale-110 group-hover:rotate-6 transition-all duration-300`}>
                  ...
                  <p className="text-slate-600 group-hover:text-slate-700 transition-colors">{step.desc}</p>
                </div>
              );
            })}
          </div>
      ...
      <section className="py-24 px-4 bg-gradient-to-br from-slate-50 to-blue-50 relative">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-20">
            ...
            <h2 className="text-4xl md:text-5xl font-bold text-slate-900 mb-6 animate-fade-in-up animation-delay-200">
              Trusted by Businesses <span className="text-blue-600">Across Industries</span>
            </h2>
            <p className="text-xl text-slate-600 animate-fade-in-up animation-delay-400">
              Our AI-powered review system works perfectly for any business that values customer feedback.
            </p>
          </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
            {industries.map((industry, index) => {
              ...
              return (
                <div key={index} className={`group ${industry.bgColor} rounded-3xl p-8 hover:shadow-2xl transition-all duration-500 hover:scale-105 hover:-translate-y-2 animate-slide-in-up animation-delay-${(index + 1) * 100}`}>
                  <div className={`w-16 h-16 bg-gradient-to-br ${industry.color} rounded-2xl flex items-center justify-center mx-auto mb-4 group-hover:scale-110 group-hover:rotate-12 transition-all duration-300 shadow-lg`}>
                    <Icon className="w-8 h-8 text-white" />
                  </div>
                  <h3 className={`font-bold text-center ${industry.textColor} group-hover:scale-105 transition-transform`}>{industry.name}</h3>
                </div>
              );
            })}
          </div>
      ...
      <section className="py-24 px-4 bg-white relative">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-20">
            ...
            <h2 className="text-4xl md:text-5xl font-bold text-slate-900 mb-6 animate-fade-in-up animation-delay-200">
              Powerful Features That <span className="bg-gradient-to-r from-purple-600 to-pink-600 bg-clip-text text-transparent">Drive Results</span>
            </h2>
            <p className="text-xl text-slate-600 max-w-3xl mx-auto animate-fade-in-up animation-delay-400">
              Everything you need to build a stellar online reputation and attract more customers.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {features.map((feature, index) => {
              ...
              return (
                <div key={index} className={`group ${feature.bgColor} rounded-3xl p-8 hover:shadow-2xl transition-all duration-500 hover:scale-105 hover:-translate-y-2 animate-slide-in-up animation-delay-${(index + 1) * 100}`}>
          ...
          <div className="grid md:grid-cols-2 gap-8 max-w-5xl mx-auto">
            ...
            <div className="group relative bg-gradient-to-br from-purple-600/20 to-blue-600/20 backdrop-blur-sm border border-purple-400/30 rounded-3xl p-8 hover:border-purple-400/50 transition-all duration-500 hover:scale-105 animate-slide-in-right animation-delay-200">
              ...
              <div className="text-center mb-8">
                ...
                <div className="text-sm text-slate-400">Renewal: ₹2,000/year</div>
              </div>
      ...
      <section className="py-24 px-4 bg-gradient-to-br from-yellow-50 to-orange-50 relative">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-20">
            ...
            <p className="text-xl text-slate-600 animate-fade-in-up animation-delay-400">
              Join thousands of businesses already growing their reputation with our platform.
            </p>
          </div>

          <div className="grid md:grid-cols-3 gap-8">
            {testimonials.map((testimonial, index) => (
              <div key={index} className={`group bg-white rounded-3xl p-8 shadow-lg hover:shadow-2xl transition-all duration-500 hover:scale-105 hover:-translate-y-2 animate-slide-in-up animation-delay-${(index + 1) * 200}`}>
                ...
                <div className="flex items-center gap-4">
                  ...
                  />
                  <div>
                    <div className="font-bold text-slate-900 group-hover:text-blue-600 transition-colors">{testimonial.name}</div>
        ...
        <div className="max-w-7xl mx-auto relative">
          <div className="text-center mb-20">
            ...
            <h2 className="text-4xl md:text-5xl font-extrabold tracking-tight text-slate-900 mb-6">
              Trusted by 2,500+ <span className="bg-gradient-to-r from-emerald-600 to-indigo-600 bg-clip-text text-transparent">Indian Businesses</span>
            </h2>
              ...
              <div className="grid lg:grid-cols-2 rounded-[inherit] bg-white/80 backdrop-blur-xl overflow-hidden">
                ...
                >
                  ...
                  <div className="mt-10 flex items-center gap-5">
                    ...
                    />
                    <div>
                      <div className="font-semibold text-slate-900 text-lg">{activeCase.author}</div>
                      <div className="text-sm text-slate-500">
                        {activeCase.title} • {activeCase.business}
                      </div>
                      <div className="text-xs text-slate-400">{activeCase.location}</div>
                    </div>
                  </div>
                ...
                <div className="relative p-10 bg-gradient-to-br from-slate-50 via-indigo-50 to-emerald-50 flex flex-col">
                  ...
                  <div className="grid grid-cols-2 gap-6 mb-8">
                    <div className="relative rounded-2xl bg-white/90 backdrop-blur border border-slate-200 p-5 text-center shadow-sm">
                      ...
                      <div className="text-3xl font-bold text-slate-800">{activeCase.before.rating}</div>
                        ...
                        <div
                          ...
                          style={{
                            width: (() => {
                              ...
                              const n = parseInt(activeCase.growthPct.replace(/[^0-9]/g, ''), 10);
                              return Math.min(100, Math.log10(n + 10) * 25 + 40) + '%';
                            })()
                          }}
                        />
                      </div>
      ...
      <section className="py-24 px-4 bg-white relative">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="space-y-4">
            {faqs.map((faq, index) => (
              <div key={index} className={`group bg-slate-50 rounded-2xl border border-slate-200 overflow-hidden hover:shadow-lg transition-all duration-300 animate-slide-in-up animation-delay-${(index + 1) * 100}`}>
                <button
            ...
            <div className="space-y-8 animate-slide-in-right animation-delay-300">
              <div>
                ...
                <div className="space-y-6">
                  {[
                    { icon: Mail, text: "support@aireviews.com", color: "text-blue-600" },
                    { icon: MessageCircle, text: "WhatsApp: +91 98765 43210", color: "text-green-600" },
                    { icon: Phone, text: "Phone: +91 11-4567-8900", color: "text-purple-600" },
                    { icon: MapPin, text: "Office: Delhi, Mumbai, Bangalore", color: "text-red-600" }
                  ].map((contact, index) => {
                    const Icon = contact.icon;
                    return (
                      <div key={index} className="flex items-center gap-4 p-4 bg-white rounded-2xl hover:shadow-lg transition-all duration-300 hover:scale-105 cursor-pointer group">
                        <div className={`w-12 h-12 ${contact.color.replace('text-', 'bg-').replace('-600', '-100')} rounded-xl flex items-center justify-center group-hover:scale-110 transition-transform`}>
                          <Icon className={`w-6 h-6 ${contact.color}`} />
                        </div>
                        <span className="text-slate-700 font-medium group-hover:text-slate-900 transition-colors">{contact.text}</span>
                      </div>
                    );
                  })}
                </div>
              ...
              <div className="bg-gradient-to-br from-green-50 to-blue-50 p-8 rounded-3xl hover:shadow-lg transition-all duration-300 hover:scale-105">
                <h4 className="text-xl font-bold text-slate-900 mb-3">Quick Start Support</h4>
                <p className="text-slate-600 mb-6 leading-relaxed">Get your first QR code and start collecting reviews in under 5 minutes with our dedicated onboarding team.</p>
        ...
        <div className="max-w-7xl mx-auto relative">
          <div className="grid md:grid-cols-4 gap-12 mb-16">
            <div className="animate-fade-in-up animation-delay-100">
              ...
              <p className="text-slate-400 mb-6 leading-relaxed">
                Helping businesses get more 5-star Google reviews with AI-powered QR codes. Trusted by 2,500+ businesses worldwide.
              </p>
              <div className="flex gap-4">
                {[Facebook, Twitter, Instagram, Linkedin].map((Icon, index) => (
                  <div key={index} className="w-10 h-10 bg-slate-800 hover:bg-slate-700 rounded-xl flex items-center justify-center cursor-pointer transition-all duration-300 hover:scale-110 hover:-translate-y-1 group">
            ...
            <div className="animate-fade-in-up animation-delay-200">
              ...
              <ul className="space-y-3">
                {["Home", "Features", "Pricing", "Industries", "About Us"].map((link, index) => (
                  <li key={index}>
                    <a href="#" className="text-slate-400 hover:text-white transition-all duration-300 hover:translate-x-2 inline-block">{link}</a>
                  </li>
                ))}
              </ul>
            </div>
            ...
            <div className="animate-fade-in-up animation-delay-300">
              ...
              <ul className="space-y-3">
                {["Help Center", "Contact Us", "WhatsApp Support", "Live Chat", "Documentation"].map((link, index) => (
                  <li key={index}>
                    <a href="#" className="text-slate-400 hover:text-white transition-all duration-300 hover:translate-x-2 inline-block">{link}</a>
                  </li>
                ))}
            ...
            <div className="animate-fade-in-up animation-delay-400">
              ...
              <p className="text-slate-400 mb-6">Get tips on building your online reputation and growing your business.</p>
          ...
          <div className="border-t border-slate-800 pt-8 flex flex-col md:flex-row justify-between items-center">
            <p className="text-slate-400 mb-4 md:mb-0">
              © 2025 AI Reviews. All rights reserved. Made with ❤️ for businesses worldwide.
            </p>
            <div className="flex gap-8 text-slate-400">
              {["Privacy Policy", "Terms of Service", "Cookie Policy"].map((link, index) => (
                <a key={index} href="#" className="hover:text-white transition-all duration-300 hover:-translate-y-1">{link}</a>
              ))}
            </div>
          </div>
        </div>
