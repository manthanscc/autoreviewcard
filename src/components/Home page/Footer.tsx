...
export const Footer: React.FC = () => {
  return (
    <footer className="bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 text-white py-14 px-4 relative overflow-hidden">
        ...
        <div className="grid md:grid-cols-4 gap-12 mb-8">
          <div className="animate-fade-in-up animation-delay-100">
            <div className="flex items-center gap-3 mb-4">
                <div>
                <img src="/logoW.png" alt="AI Reviews logo" className="w-20 h-20 object-contain" />
                </div>
              <h3 className="text-2xl font-bold">Review <br/> Automation</h3>
            </div>
